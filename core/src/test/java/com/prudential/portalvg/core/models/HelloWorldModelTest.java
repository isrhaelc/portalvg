 ...
 */
package com.prudential.portalvg.core.models;
...
import com.prudential.portalvg.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "portalvg/components/helloworld");
